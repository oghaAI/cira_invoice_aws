...
- [CIRA Invoice Processing System Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [ProcessingEvent Model](./data-models.md#processingevent-model)
  - [Components](./components.md)
    ...
    - [Cost Tracking Service](./components.md#cost-tracking-service)
    - [Component Diagrams](./components.md#component-diagrams)
  - [Core Workflows](./core-workflows.md)
    - [Invoice Processing Workflow](./core-workflows.md#invoice-processing-workflow)
  ...
  - [Error Handling Strategy](./error-handling-strategy.md)
    ...
    - [Business Logic Error Handling](./error-handling-strategy.md#business-logic-error-handling)
